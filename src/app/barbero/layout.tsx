      ...
      <header style={{ borderBottom: "1px solid #27272A", background: "#18181B", position: "sticky", top: 0, zIndex: 50 }}>
        <nav style={{ maxWidth: 1200, margin: "0 auto", padding: "16px 24px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <div style={{ display: "flex", gap: 32, alignItems: "center" }}>
            <Link href="/barbero" style={{ fontSize: 14, color: "#A1A1AA" }}>Mis Citas</Link>
            <button onClick={handleLogout} style={{ fontSize: 14, color: "#EF4444", background: "rgba(239, 68, 68, 0.1)", border: "none", cursor: "pointer", padding: "8px 16px", borderRadius: 6 }}>
              Cerrar sesión
            </button>
          </div>
        </nav>
